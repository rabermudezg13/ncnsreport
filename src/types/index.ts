...
export interface Incident {id:string;substituteId:string;substituteName:string;bhNumber?:string;ksnNumber?:string;sourceRecordId?:string;confirmationNumber?:string;schoolId?:string;schoolName:string;district?:string;state?:string;incidentDate:Timestamp;scheduledTime:string;incidentType:IncidentType;responseStatus:ResponseStatus;responseDateTime?:Timestamp;responseMethod?:"phone"|"text"|"email"|"other";reasonProvided?:string;followUpNotes?:string;notes?:string;createdBy:string;createdByName:string;createdAt:Timestamp;updatedBy?:string;updatedAt:Timestamp}
