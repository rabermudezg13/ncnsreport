...
export interface Incident {id:string;substituteId:string;substituteName:string;bhNumber?:string;ksnNumber?:string;sourceRecordId?:string;schoolId?:string;schoolName:string;incidentDate:Timestamp;scheduledTime:string;incidentType:IncidentType;responseStatus:ResponseStatus;responseDateTime?:Timestamp;responseMethod?:"phone"|"text"|"email"|"other";reasonProvided?:string;followUpNotes?:string;notes?:string;createdBy:string;createdByName:string;createdAt:Timestamp;updatedBy?:string;updatedAt:Timestamp}
